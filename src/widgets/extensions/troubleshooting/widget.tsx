...
export interface TroubleshootingWidgetProps {
  data?: TroubleshootingPlan;
 ...
 */
export function deriveFallbackTroubleshootingPlan(query: string, result?: SearchSynthesisResult): TroubleshootingPlan {
...
export const TroubleshootingWidget: React.FC<TroubleshootingWidgetProps> = (props) => {
  ...
  // 1. 优先使用已转换的 data，其次使用 Agent 产出的结构化故障计划，未产出时实时推导
